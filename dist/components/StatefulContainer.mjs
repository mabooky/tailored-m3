...
import { t as BG_SYSTEM_COLOR_MAP } from "../types-k-_ePeZ7.mjs";
import { jsx, jsxs } from "react/jsx-runtime";

//#region src/components/StatefulContainer.tsx
function StatefulContainer({ ref, className, stateLayerColor, selected = false, disabled = false, children, ...props }) {
